function AddonDouble_State_Button_create(){
    ...
    function handleTouchActions() {
        ...
        if( presenter.configuration.isImageChoice ){
    ...
    function createTextElement(element) {
        ...
        //이석웅 추가
		//text center 정렬인경우 css 별도 적용




		//if( isTextAlignCenter() ) tCss = "doublestate-button-text-center"
    ...
    function createElements(wrapper) {
		...
		if( !presenter.configuration.isImageChoice && isCenter ){
			CSS_CLASSES = {
		        ELEMENT : "doublestate-button-element-center",
		        MOUSE_HOVER : "doublestate-button-element-mouse-hover-center",
		        MOUSE_CLICK : "doublestate-button-element-mouse-click",
		        SELECTED : "doublestate-button-element-selected-center",
		        SELECTED_MOUSE_HOVER : "doublestate-button-element-selected-mouse-hover-center",
    ...
    presenter.setElementSelection = function() {
		...
		//var tCss = isTextAlignCenter(element)? ".doublestate-button-text-center" : ".doublestate-button-text";
		var tCss = ".doublestate-button-text"
        var textElement = $(element).find(tCss);
        textElement.html(presenter.isSelected() ? presenter.configuration.selected.text : presenter.configuration.deselected.text);
    ...
    presenter.updateLaTeX = function () {
        ...
        var textElement = presenter.$view.find(tCss)[0];
